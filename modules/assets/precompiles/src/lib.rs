    ...
    alloy::primitives::U256: TryFrom<<Runtime as Config<Instance>>::Balance>,
{
    ...
    fn total_supply(
        ...
        let value = Self::to_u256(pallet_assets::Pallet::<Runtime, Instance>::total_issuance(
            asset_id,
        ))?;
    ...
    fn balance_of(
        ...
        let value = Self::to_u256(pallet_assets::Pallet::<Runtime, Instance>::balance(
            asset_id, account,
        ))?;
