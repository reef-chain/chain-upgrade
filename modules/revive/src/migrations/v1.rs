...
use crate::{weights::ReviveWeightInfo, AccountInfo, AccountInfoOf, Config, H160};
use frame_support::{
...
impl<T: Config> SteppedMigration for Migration<T> {
    ...
    fn step(
        ...
        let required = <T as Config>::ReviveWeightInfo::v1_migration_step();
